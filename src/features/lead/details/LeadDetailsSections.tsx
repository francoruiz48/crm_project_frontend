                    ...
                    <ColoredAccordionSummary expandIcon={<ArrowDropDownIcon />}
                        ...
                        {editingSectionId === section.id ? (
                            ...
                            <Typography variant="h2" sx={{ cursor: "text" }}
                                //El nombre de la sección deja de reaccionar al clic simple, para que un doble clic
                                //pueda entrar en modo edición sin que el acordeón parpadee. 
                                //El resto del encabezado sigue plegando/desplegando con un clic normal.
                                onClick={stopPropagationEvent()}
...
export const LeadFieldContent = (props: LeadFieldProps) => {
    ...
    //Todos los tipos de campo son editables inline, salvo los calculados,
    //los no visibles/editables (is_visible), los LEAD con algún
    //valor restringido (ver arriba), y si el usuario no tiene permiso "lead:update".
